...
In this section, you can find *all* the commands of EYLA together with
...
`ITEMNAME`, `ITEMPRICE` and `NAME` are parameters which can decided by you,
...
.Main Menu Help
image::main_help.png[width="890", height="300"]

*Diet Tracker Mode:*

.Diet Tracker Help
image::diethelp.png[width="890",height="300"]
